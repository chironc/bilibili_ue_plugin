...
class BILIBILI_API UBlueprintJsonObject : public UObject
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Get Float By Path", Keywords = "Json Get Float By Path", ShortTooltip = "Gets a certain float from the Json Object"), Category = "Json|Object")
	bool GetFloatByPath(FString Path, float& Value);
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Get Array By Path", Keywords = "Json Get Array By Path", ShortTooltip = "Gets a certain Json Array from the Json Object without specifying a type"), Category = "Json|Object")
	bool GetArrayByPath(FString Path, TArray<UBlueprintJsonValue*>& Values);
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Get Object By Path", Keywords = "Json Get Object By Path", ShortTooltip = "Gets a certain Json Object from the Json Object"), Category = "Json|Object")
	bool GetObjectByPath(FString Path, UBlueprintJsonObject*& Value);
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Get String By Path", Keywords = "Json Get String By Path", ShortTooltip = "Gets a certain string from the Json Object"), Category = "Json|Object")
	bool GetStringByPath(FString Path, FString& Value);
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Get Integer By Path", Keywords = "Json Get Integer By Path", ShortTooltip = "Gets a certain integer from the Json Object"), Category = "Json|Object")
	bool GetIntegerByPath(FString Path, int32& Value);
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Get Boolean By Path", Keywords = "Json Get Boolean By Path", ShortTooltip = "Gets a certain boolean from the Json Object"), Category = "Json|Object")
	bool GetBooleanByPath(FString Path, bool& Value);
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Get Value By Path", Keywords = "Json Get Value By Path", ShortTooltip = "Gets a certain value from the Json Object without specifying it's type"), Category = "Json|Object")
	bool GetValueByPath(FString Path, UBlueprintJsonValue*& Value);
};
